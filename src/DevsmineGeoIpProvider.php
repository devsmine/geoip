...
use TextMine\Model\Setting;
use Exception;

class DevsmineGeoIpProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->app->bind('TextMine\Library\Contracts\GeoIpInterface', function ($app) {
